...
#ifndef SRC_PROGRAM_INSTRUCTIONSEQUENCE_PROGRAMSTATE_H_
#define SRC_PROGRAM_INSTRUCTIONSEQUENCE_PROGRAMSTATE_H_
...
#endif /* SRC_PROGRAM_INSTRUCTIONSEQUENCE_PROGRAMSTATE_H_ */
